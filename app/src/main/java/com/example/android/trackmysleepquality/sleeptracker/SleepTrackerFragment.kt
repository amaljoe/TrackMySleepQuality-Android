...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val viewModelFactory = SleepTrackerViewModelFactory(dataSource, requireActivity().application)
        ...
        viewModel.navigateToSleepQuality.observe(viewLifecycleOwner, Observer {
            if(it !=null) {
                val action = SleepTrackerFragmentDirections.actionSleepTrackerFragmentToSleepQualityFragment(it.nightId)
